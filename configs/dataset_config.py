configs = {
    'yelp': lambda args: {'name': 'YelpDataset', 'path': 'data/Yelp_pro', 
    ...
    'career': lambda args: {'name': 'CareerDataset', 'path': 'data/Career_pro',
        'device': args.device, 'split_ratio': [0.7, 0.1, 0.2], 'min_inter': 0, 'n_groups': 10, 'gamma': 1.936},
}
